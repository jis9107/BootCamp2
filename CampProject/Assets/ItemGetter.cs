...
public class ItemGetter : MonoBehaviour
{
    ...
    private void OnTriggerEnter2D(Collider2D other)
    {
        ...
        Debug.Log(newObject);
        newObject.GetComponent<GettedObject>().SetItemData(other.GetComponent<SpwanedItem>().itemData);
        ...
        RectTransformUtility.ScreenPointToLocalPointInRectangle(
            canvas.GetComponent<RectTransform>(), newScreenPosition, _camera, out localPoint);
